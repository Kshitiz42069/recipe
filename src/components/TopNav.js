...
const TopNav = () => {
  ...
  return (
    <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
        ...
        <div className={sidenav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-400' :
            ...
            <nav>
                <ul className='flex flex-col p-4 text-gray-900'>
                    <li className='text-xl py-4 flex hover:cursor-default'>
                        <BsPerson size={25} className='mr-4 text-black rounded-full '/>
                        My Account
                    </li>
                    <li className='text-xl py-4 flex  hover:cursor-default'>
                        <TbTruckReturn size={25} className='mr-4 text-black rounded-full'/>
                        Delivery
                    </li>
                    <li className='text-xl py-4 flex hover:cursor-default'>
                        <MdOutlineFavorite size={25} className='mr-4 text-black rounded-full'/>
                        My Favourite
                    </li>
                    <li className='text-xl py-4 flex hover:cursor-default'>
                        <FaGoogleWallet size={25} className='mr-4 text-black rounded-full'/>
                        My Wallet
                    </li>
                    <li className='text-xl py-4 flex hover:cursor-default'>
                        <MdHelp size={25} className='mr-4 text-black rounded-full'/>
                        Help
                    </li>
                </ul>
            </nav>
